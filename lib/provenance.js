...
export const ORIGINES = {
  ...
  /*
   * IMPORTÉ D'UN PACK EXTERNE. La sixième, et elle se relit encore autrement.
   *
   * Aucun modèle n'a rédigé ce fichier, et pourtant il n'a pas non plus été écrit à la
   * main : deux champs viennent de l'amont, les autres ont été DÉCIDÉS par l'importeur, et
   * le `spec` contient un document markdown écrit par un tiers. Le relecteur ne cherche
   * donc ni ce qu'un modèle a inventé, ni ce qu'un auteur a oublié : il cherche ce que
   * l'amont essaie de lui faire faire. Ce ne sont toujours pas les mêmes yeux.
   */
  import: 'Importé d\'un pack externe, champs décidés par l\'importeur'
};
